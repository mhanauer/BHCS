...
efa_General_Health2 = fa(r = General_Health, nfactors = 2, missing = TRUE, n.iter = 100, impute = "median", fm = "gls", cor = "poly")

anova(efa_General_Health, efa_General_Health2)
...
paran(Career_Education, centile = 95, iterations = 100, graph = TRUE, cfa = TRUE)
...
fit11 = cfa(model11, estimator = "MLR",  missing = "fiml", std.lv = TRUE, data = CIL_CKYFull)
...
fit1_1 = cfa(model1_1, estimator = "MLR",  missing = "fiml", data = CIL_CKYFull)
summary(fit1_1, standardized=TRUE, fit.measures = TRUE)
