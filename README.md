...
model_Neighborhood_Enviornment  = 'Neighborhood_Enviornment =~ safe_neighborhood+ near_supports+ has_transport'
fit_Neighborhood_Enviornment =cfa(model_Neighborhood_Enviornment , estimator = "MLR", data = CIL_CKYEachCon)
summary(fit_Neighborhood_Enviornment, fit.measures = TRUE, standardized = TRUE)
